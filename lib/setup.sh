...
git clone --branch live $WP_MY_DIR $LIVE_WORDPRESS_DIR
...
echo ""
echo "When a new version of WordPress is released, download the tar.gz file into the wordpress_tars directory and call run.sh."
echo ""
exit 2
